...
class DetailPekerjaanActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener,
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (isGPSEnabled()) {
                ...
                if (latitude != null && longitude != null) {
                    ...
                    val location = latitude!!.toDoubleOrNull()?.let {
    ...
    private fun showGPSDisabledDialog() {
        ...
        alert.setOnShowListener {
            ...
            alert.getButton(AlertDialog.BUTTON_POSITIVE)?.setTextColor(
                ContextCompat.getColor(this@DetailPekerjaanActivity, android.R.color.black)
            )
